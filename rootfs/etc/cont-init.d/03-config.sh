...
FLARUM_BASE_URL=${FLARUM_BASE_URL:-http://forum.ourhouse.services}
FLARUM_FORUM_TITLE="${FLARUM_FORUM_TITLE:-OurHouse.Services}"
FLARUM_API_PATH="${FLARUM_API_PATH:-api}"
FLARUM_ADMIN_PATH="${FLARUM_ADMIN_PATH:-admin}"
FLARUM_ADMIN_USER="${FLARUM_ADMIN_USER:-cirfis}"
#FLARUM_ADMIN_PASSWORD="${FLARUM_ADMIN_PASSWORD:-cirfis}"
#DB_HOST=${DB_HOST:-localhost}
DB_PORT=${DB_PORT:-3306}
DB_NAME=${DB_NAME:-flarum}
DB_USER=${DB_USER:-cirfis}
...
adminUser:
  ...
  password_confirmation: cirfis
  email: cirfis@gmail.com
settings:
